...
@section('content')
    ...
    <section class="relative h-[50vh] flex items-center bg-[#001e46] text-white overflow-hidden pt-20">
        <div class="absolute inset-0">
            <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80" class="w-full h-full object-cover opacity-40" alt="img">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 w-full">
            ...
            <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight">Ponerse en <span class="text-[#c85a00]">Contacto</span></h1>
        </div>
    </section>
                ...
                <div class="lg:col-span-1 space-y-12">
                    ...
                    <div class="space-y-8">
                        <div class="flex items-start gap-6 group">
                            <div class="w-12 h-12 bg-orange-100 rounded-2xl flex items-center justify-center shrink-0 text-[#c85a00] group-hover:bg-orange-600 group-hover:text-white transition-all duration-300 shadow-sm">
                            ...
                            <div class="grid sm:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" x-model="email" required
                                        ...
                                        class="w-full bg-white rounded-xl px-4 py-4 text-sm focus:ring-2 focus:ring-[#c85a00] outline-none transition-all border shadow-sm" placeholder="juan@ejemplo.com">
                                </div>
                            </div>
                            <div class="grid sm:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="tel" name="phone" x-model="phone" required
                                        ...
                                        class="w-full bg-white rounded-xl px-4 py-4 text-sm focus:ring-2 focus:ring-[#c85a00] outline-none transition-all border shadow-sm" placeholder="987 654 321">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="subject" x-model="subject" required
                                        ...
                                        class="w-full bg-white rounded-xl px-4 py-4 text-sm focus:ring-2 focus:ring-[#c85a00] outline-none transition-all border shadow-sm" placeholder="Ej. Presupuesto Obra Civil">
                                </div>
                            </div>
                            <div>
                                ...
                                <textarea name="message" x-model="message" rows="5" required
                                    ...
                                    class="w-full bg-white rounded-xl px-4 py-4 text-sm focus:ring-2 focus:ring-[#c85a00] outline-none transition-all border shadow-sm" placeholder="Cuéntenos sobre su requerimiento o consulta técnica..."></textarea>
                            </div>
