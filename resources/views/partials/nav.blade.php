    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="md:hidden flex items-center">
                <button @click="open = !open" type="button" :class="{ 'text-gray-900': !atTop, 'text-white': atTop }" class="inline-flex items-center justify-center p-2 rounded-md focus:outline-none transition-colors">
