<script setup>
    ...
    const form = useForm({
        ...
        minutes_subject: props.accordance.minutes_subject,
        minutes_type: props.accordance.minutes_type,
        minutes_code: props.accordance.minutes_code,
        meeting_date: props.accordance.meeting_date,
        participants: props.accordance.participants,
        minutes_body: props.accordance.minutes_body,
        status: props.accordance.status,
        sql_errors: null
    });

    const updateAccordance = () => {
        form.post(route('even_ediciones_actas_update'), {
            forceFormData: true,
            errorBag: 'updateAccordance',
            preserveScroll: true,
            onSuccess: () => {
                Swal2.fire({
                    title: 'Enhorabuena',
